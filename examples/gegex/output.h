extern const unsigned zebu_shifts[9][12];
extern const unsigned zebu_reduces[10][9];
extern const unsigned zebu_lexer[21][101];
extern const unsigned zebu_firsts[13][10];
extern const unsigned zebu_starts[10];
extern const unsigned zebu_defaults[1];
extern const unsigned zebu_EOFs[14];
extern const unsigned zebu_accepts[22];
extern const char* zebu_grammar_names[14];
#include <stddef.h>
struct zebu_state;
