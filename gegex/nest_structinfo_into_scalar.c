...
#include <yacc/structinfo/add_substructinfo_scalar_field.h>
#include <yacc/structinfo/free.h>

#include "transition/struct.h"
#include "struct.h"
#include "nest_structinfo_into_scalar.h"

void gegex_nest_structinfo_into_scalar(
	struct gegex* start,
	struct string* nestas)
{
	...
	while (quack_is_nonempty(todo))
	{
		...
		for (unsigned i = 0, n = state->transitions.n; i < n; i++)
		{
			...
			structinfo_add_substructinfo_scalar_field(new, nestas, t->structinfo);
